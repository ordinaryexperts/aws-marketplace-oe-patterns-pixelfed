...
# on Tue Apr 28 01:47:01 UTC 2026.
# Restored to dev AMI on develop after 2.1.0 release for taskcat
# (prod AMI ami-00c523e809c5cffa1 only exists in oe-patterns-prod).
AMI_ID="ami-0865fa7cb24c981fa"
AMI_NAME="ordinary-experts-patterns-pixelfed-2.1.0-20260428-0134"
...
generated_ami_ids = {
    ...
    "us-east-1": "ami-0865fa7cb24c981fa"
}
...
class PixelfedStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        CfnOutput(
            ...
            value="""
Click on the DnsSiteUrlOutput link and register a new user. Then you can make that user an admin by connecting to the EC2 instance with SSM Sessions Manager and running this command:

sudo su - root -c 'read -p \"Enter username: \" username && cd /usr/share/webapps/pixelfed && php artisan user:admin $username && php artisan cache:clear'
"""
        )
