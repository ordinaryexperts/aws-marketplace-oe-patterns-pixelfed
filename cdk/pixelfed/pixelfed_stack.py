...
# on Wed Jun 14 07:18:19 UTC 2023.
AMI_ID="ami-03153015fde768a1f"
AMI_NAME="ordinary-experts-patterns-pixelfed-1.0.0-20230614-0703"
generated_ami_ids = {
    ...
    "us-east-1": "ami-03153015fde768a1f"
}
...
class PixelfedStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        CfnOutput(
            ...
            value=f"Click on the DnsSiteUrlOutput link and register a new user. Then you can make that user an admin with the 'php artisan user:admin username_here' command on the instance after logging in with SSM Sessions Manager. See more here: https://docs.pixelfed.org/running-pixelfed/administration/"
        )
